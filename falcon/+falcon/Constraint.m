classdef Constraint < falcon.core.OVC & falcon.core.HasProblem & falcon.core.HasActive
    % The falcon.Constraint class is an optimization value container for constraint
    % values. Constraints can be set active or inactive using the Active
    % property.
    ...
    methods
        ...
        function obj = Constraint(name, varargin)
        % Constructor for falcon.Constraint object. Each constraint needs to have at
        % least a valid name.
        %  
        % <Syntax>
        % obj = falcon.Constraint(name)
        % obj = falcon.Constraint(name, lowerBound)
        % obj = falcon.Constraint(name, lowerBound, upperBound)
        % obj = falcon.Constraint(name, lowerBound, upperBound, scaling)
        % obj = falcon.Constraint(name, lowerBound, upperBound, scaling, offset)
        % obj = falcon.Constraint(name, lowerBound, upperBound, scaling, offset, active)
        % obj = falcon.Constraint(name, 'Name', Value)
        %  
        % <Inputs>
