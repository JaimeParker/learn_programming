classdef FinitDifferenceDerivative < falcon.core.builder.DerivativeBuilder
    % FFINITDIFFERENCEDERIVATIVE Summary of this class goes here
    ...
    methods
        function obj = FinitDifferenceDerivative(varargin)
        % FFINITDIFFERENCEDERIVATIVE Summary of this class goes here
        %   Detailed explanation goes here
        end
