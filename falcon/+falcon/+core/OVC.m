classdef (Abstract) OVC < falcon.core.HasProblem & falcon.core.HasToStruct & falcon.core.Handle & falcon.core.HasName & falcon.core.HasBounds & matlab.mixin.Heterogeneous & matlab.mixin.CustomDisplay
    % Optimization Value Container falcon.core.OVC. Each scalar that is required for the
    % optimization in the optimal control problem implemented in FALCON.m is
    % derived from the falcon.core.OVC class. The class offers basic functionality with a
    % name, scaling and offset as well as lower and upper bound.
