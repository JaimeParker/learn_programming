classdef ConsoleLogger < falcon.auxiliary.FileWriter
    % -------------------------------------------------------------------------
    %                                FALCON.m
    ...
    methods
        ...
        function self = infoItem(self, format, varargin)
        % falcon.auxiliary.ConsoleLogger/infoItem is a function.
        %   [self] = infoItem(self, format, varargin)
        end

        function self = info(self, format, varargin)
