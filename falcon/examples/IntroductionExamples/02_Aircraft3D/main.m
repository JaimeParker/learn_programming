...
% Calculate thrust:
mdl.addSubsystem(@(C_T) 2e5 * C_T, {'C_T'}, {'T'});
...
mdl.Build('EvaluationProvider','mex');      % Mex evaluation (default)
% % mdl.Build('EvaluationProvider','matlab');	% Matlab evaluation (automatic fallback if there exists no compiler on system)
