classdef AnalyticDerivative < falcon.core.builder.DerivativeBuilder
    % The Model Builder class enables a user to create a complex
    % function (or dynamic model) that contains different subsystem to
    % create the overall system with the derivatives up to the second
    % derivative (hessian).
    ...
    methods
        function obj = AnalyticDerivative(varargin)
        % Create an anlytic derivative object
        %  
        % <Keywords>
        % Builder!Analytic Derivative
        end
