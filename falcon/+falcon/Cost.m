classdef Cost < falcon.core.OVC & falcon.core.HasProblem
    % values.
    ...
    methods
        function obj = Cost(name, varargin)
        % Constructor for falcon.Cost object. Each cost function part needs to have at
        % least a valid name.
        %  
        % <Syntax>
        % obj = falcon.Cost(name)
        % obj = falcon.Cost(name, scaling)
        %  
        % <Inputs>
        % >name: The name of this part of the cost function.
        % >scaling: Scaling of the cost.
        %  
        % <Keywords>
        % Constructor!Cost
        end
