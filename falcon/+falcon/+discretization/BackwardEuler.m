classdef (Abstract) BackwardEuler < falcon.discretization.DiscretizationMethod
    ...
    methods
        function obj = BackwardEuler()
        % This class represents a backward Euler collocation method
        end

        function [G, H] = evaluateGandH(obj, z, lambda)
        % Evaluates the jacobian and the hessian.
        %  
        % <Keywords>
        % Discretization!Evaluate!Hessian; Discretization!Evaluate!Gradient
        end
